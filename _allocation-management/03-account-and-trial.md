...
Your account is associated with your email address and will contain account-related information, such as your public-private key pairs (when you register them), your Nectar OpenStack password or any Application Credentials you might create.
...
In this project you are allocated a very limited quota of 2vCPU of resources for a maximum of 6 vCPU-month of running time. The project also has a time limit of 180 days (approx 6 months).
