...
![img]({{ site.baseurl }}/assets/images/advanced-networking/nlQ9Lqq-XsAuZozdJd_9CZpWEmlEqeve8w.png)
...
![img]({{ site.baseurl }}/assets/images/advanced-networking/07sisG9nLlxu3v-ms4IyBhS53amdf-C5uQ.png)
...
Step 6c. Verify the floating IP is now present in the Dashboard (you may need to refresh the page) and try logging in to your instance:![img]({{ site.baseurl }}/assets/images/advanced-networking/uFLqpIV1xvGAFbw0tfKq3V5NXrIPqlQ0zQ.png)
