...
In this section, we are going to use the python openstack client to create and manage the database instances.

### Installation

```
apt get install python3-openstackclient python3-troveclient
```
...
```
$ openstack database instance create my-database-instance db.small --datastore MySQL --datastore_version 8.0-12 --size 1 --availability_zone melbourne-qh2
+-------------------+--------------------------------------+
| Property          | Value                                |
+-------------------+--------------------------------------+
...
```
$ openstack database user create 5de589ae-195e-4859-ae6f-8bd014094bd3 tutorial_cli 123456 --databases tutorial_cli
