...
1. The default zone for a project is in the form `<project-name>.cloud.edu.au.`.
2. Project trials (PT's) do not have a DNS zone.  You need an allocation in order to use Nectar DNS.
{: .callout-warning}
