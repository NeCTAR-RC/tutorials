...
project has the default zone using the Nectar dashboard, by navigating to **Project -> DNS -> Zones**.
# The default zone for a project is in the form `<project-name>.cloud.edu.au.`.
# Project trials (PT's) do not have default zone.  You need an allocation in order to use Nectar DNS.
